...
int main() {
    ...
    //READ FILES AND MAKE GRAPH
    Graph g;
    string line;
    vector<string> ids;

    ifstream file("list_attr_celeba.txt");
    if (file.is_open()) {
        ...
        for (int i = 0; i < counter; i++) {
            ...
            string id;
            getline(file, line);
            // this loop converts -1 and 1 to 0 and 1! Nobody TOUCH THIS       LOOP
            while (count < line.length() - 1) {
                ...
                if (line.at(count) == '-') {
                    neg = true;
                    temp += "0";
                } else if (count > 10 && line.at(count) == '1') {
                    // count += 1;
                    // neg = true;
                    temp += "1";
                }
            ...
            // DO NOT TOUCH LINES 31 - 58
            string imageName = line.substr(0, 10);

            if (temp.at(20) == '1') { // m: man f: female
                id += "m";
                // cout << "this is a man" << endl;
            } else
                id += "f";

            if (temp.at(4) == '1') { // o: bald
                id += "o";
                // cout << "this person is bald" << endl;

            } else if (temp.at(8) == '1') { // b: black
                id += "b";
                // cout << "this person has black hair" << endl;
            } else if (temp.at(9) == '1') { // y: blonde
                id += "y";
                // cout << "this person has blonde hair" << endl;
            } else if (temp.at(11) == '1') { // r: brown
                id += "r";
                // cout << "this person has brown hair" << endl;
            } else if (temp.at(17) == '1') { // g: gray
                id += "g";
                // cout << "this person has gray hair" << endl;
            } else // misc
                id += "x";

            if (temp.at(26) == '1') { // p: pale/white
                id += "p";
                // cout << "this person has privilege" << endl;
            } else // people of color
                id += "c";

            if (temp.at(32) == '1') { // s: straight hair
                id += "s";
                // cout << "this person has straight hair" << endl;
            } else if (temp.at(33) == '1') { // w: wavy hair
                id += "w";
                // cout << "this person has wavy hair" << endl;
            } else
                id += "z";

            if (temp.at(22) == '1') { // m: mustache
                id += "m";
                // cout << "this person mustache you a question" << endl;
            } else if (temp.at(24) == '0') { // n: beard
                id += "n";
                // cout << "this person does not have a beard" << endl;
            } else if (temp.at(16) == '1') { // t: goatee
                id += "t";
                // cout << "this person has a goatee" << endl;
            } else
                id += "z"; // none

            if (temp.at(5) == '1') { // b: bangs
                id += "b";
                // cout << "this person has bangs" << endl;
            } else
                id += "z";

            if (temp.at(6) == '1') { // l: lips
                id += "l";
                // cout << "this person has big lips" << endl;
            } else
                id += "z";

            if (temp.at(7) == '1') { // n: nose
                id += "n";
                // cout << "this person has a big nose" << endl;
            } else
                id += "z";

            if (temp.at(15) == '1') { // e: eyeglasses
                id += "e";
                // cout << "this person has glasses" << endl;
            } else
                id += "z";

            if (temp.at(39) == '1') { // y: young
                id += "y";
                // cout << "this person is young" << endl;
            } else
                id += "z"; // old
            cout << imageName << endl;
            // cout << "id: " << id << endl;
